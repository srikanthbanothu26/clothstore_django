...
from .views import cart_view, add_to_cart, remove_from_cart, checkout_page, Delete_address, Add_Address, make_orders
...
urlpatterns = [
    ...
    path("make_orders/<int:shirt_id>/", make_orders, name="make_orders"),
